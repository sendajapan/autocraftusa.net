                        ...
                        <div class="widget-content">
                            ...
                            <div class="tabbable">
                                <div class="tab-content">
                                    ...
                                    <form id="edit-profile" action="<?= base_url('admin/stock/update') ?>" method="post"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="span6" id="stock_no" name="stock_no"
                                                        value="<?=$veh['stock_no']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="span6" id="model_code" name="model_code"
                                                        value="<?=$veh['model_code']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="span6" id="chassis" name="chassis"
                                                        value="<?=$veh['chassis']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="span6" id="engine_no" name="engine_no"
                                                        value="<?=$veh['engine_no']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="span6" id="engine_type" name="engine_type"
                                                        value="<?=$veh['engine_type']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="body_type" name="body_type">
                                                        ...
                                                        <option
                                                            <?php if($veh['body_type'] == strtoupper($item['BodyStyleID1Name'])){echo 'selected';} ?>
                                                            value="<?=strtoupper($item['BodyStyleID1Name'])?>">
                                                            <?=strtoupper($item['BodyStyleID1Name'])?></option>
                                                        <?php } ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="make" name="make"
                                                        onchange="load_models_by_name(this.value);">
                                                        <option disabled selected value="">Select any Make</option>
                                                        <?php foreach($makes as $item){ ?>
                                                        <option
                                                            <?php if(strtoupper($veh['make']) == strtoupper($item['make_name'])){echo 'selected';} ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="model" name="model">
                                                        ...
                                                        <option
                                                            <?php if(strtoupper($veh['model']) == strtoupper($item)){echo 'selected';} ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="fuel" name="fuel">
                                                        ...
                                                        <option
                                                            <?php if($veh['fuel'] == "Gasoline"){echo 'selected';} ?>
                                                            value="Gasoline">Gasoline</option>
                                                        <option <?php if($veh['fuel'] == "Diesel"){echo 'selected';} ?>
                                                            value="Diesel">Diesel</option>
                                                        <option <?php if($veh['fuel'] == "Hybrid"){echo 'selected';} ?>
                                                            value="Hybrid">Hybrid</option>
                                                        <option <?php if($veh['fuel'] == "LPG"){echo 'selected';} ?>
                                                            value="LPG">LPG</option>
                                                        <option <?php if($veh['fuel'] == "Other"){echo 'selected';} ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="veh_condition" name="veh_condition">
                                                        ...
                                                        <option
                                                            <?php if($veh['veh_condition'] == "Used"){echo 'selected';} ?>
                                                            value="Used">Used</option>
                                                        <option
                                                            <?php if($veh['veh_condition'] == "New"){echo 'selected';} ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <label class="radio inline">
                                                        <input type="radio" id="traction1" name="traction" value=""
                                                            <?php if($veh['traction'] == ""){echo 'checked';} ?>> N/A
                                                    </label>
                                                    <label class="radio inline">
                                                        <input type="radio" id="traction2" name="traction" value="2WD"
                                                            <?php if($veh['traction'] == "2WD"){echo 'checked';} ?>> 2WD
                                                    </label>
                                                    <label class="radio inline">
                                                        <input type="radio" id="traction3" name="traction" value="4WD"
                                                            <?php if($veh['traction'] == "4WD"){echo 'checked';} ?>> 4WD
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <label class="radio inline">
                                                        <input type="radio" id="drive1" name="drive" value="RHD"
                                                            <?php if($veh['drive'] == "RHD"){echo 'checked="checked"';} ?>>
                                                        RHD
                                                    </label>
                                                    <label class="radio inline">
                                                        <input type="radio" id="drive2" name="drive" value="LHD"
                                                            <?php if($veh['drive'] == "LHD"){echo 'checked="checked"';} ?>>
                                                        LHD
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="month" name="month">
                                                        ...
                                                        <?php for($i=1; $i<=12; $i++){ ?>
                                                        <option <?php if($veh['month'] == $i){echo 'selected';} ?>
                                                            value="<?=$i?>">
                                                            <?=date("M", strtotime(date("2017-".$i."-01")))?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="year" name="year">
                                                        ...
                                                        <option <?php if($veh['year'] == $i){echo 'selected';} ?>
                                                            value="<?=$i?>"><?=$i?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div> <!-- /controls -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="doors" name="doors">
                                                        ...
                                                        <?php for($i=0; $i<=10; $i++){ ?>
                                                        <option <?php if($veh['doors'] == $i){echo 'selected';} ?>
                                                            value="<?=$i?>"><?=$i?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div> <!-- /controls -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="seats" name="seats">
                                                        ...
                                                        <?php for($i=0; $i<=60; $i++){ ?>
                                                        <option <?php if($veh['seats'] == $i){echo 'selected';} ?>
                                                            value="<?=$i?>"><?=$i?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div> <!-- /controls -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" step="any" class="span6" id="cc" name="cc"
                                                        value="<?=$veh['cc']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" step="any" class="span6" id="mileage"
                                                        name="mileage" value="<?=$veh['mileage']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="transmission" name="transmission">
                                                        ...
                                                        <option
                                                            <?php if($veh['transmission'] == $item){echo 'selected';} ?>
                                                            value="<?=$item?>"><?=$item?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div> <!-- /controls -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" step="any" class="span6" id="gross_weight"
                                                        name="gross_weight" value="<?=$veh['gross_weight']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" step="any" class="span6" id="net_weight"
                                                        name="net_weight" value="<?=$veh['net_weight']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" step="any" class="span6" id="length"
                                                        name="length" value="<?=$veh['length']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" step="any" class="span6" id="width"
                                                        name="width" value="<?=$veh['width']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" step="any" class="span6" id="height"
                                                        name="height" value="<?=$veh['height']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" step="any" class="span6" id="m3" name="m3"
                                                        value="<?=$veh['m3']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="span6" id="model_grade" name="model_grade"
                                                        value="<?=$veh['model_grade']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                                ...
                                                <div class="controls">
                                                    <select class="span2" id="exterior_color" name="exterior_color">
                                                        ...
                                                        <option value="<?=strtoupper($item)?>"
                                                            <?php if(strtoupper($item)==strtoupper($veh['exterior_color'])){echo ' selected=selected ';} ?>>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span2" id="interior_color" name="interior_color">
                                                        ...
                                                        <?php foreach($color as $item){ ?>
                                                        <option value="<?=strtoupper($item)?>"
                                                            <?php if(strtoupper($item)==strtoupper($veh['interior_color'])){echo ' selected=selected ';} ?>>
                                                            <?=strtoupper($item)?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            ...
                                            <script>
                                            document.getElementById('exterior_color_display').style.backgroundColor =
                                                '<?=@$exterior_color_code?>';
                                            document.getElementById('interior_color_display').style.backgroundColor =
                                                '<?=@$interior_color_code?>';
                                            </script>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select class="span4" id="status" name="status">
                                                        <option disabled value="">Select Current Status for Vehicle
                                                        </option>
                                                        <option selected value="AVAILABLE"
                                                            <?php if($veh['status'] == "AVAILABLE"){echo 'selected';} ?>>
                                                            AVAILABLE</option>
                                                        <option value="BOOKED"
                                                            <?php if($veh['status'] == "BOOKED"){echo 'selected';} ?>>
                                                            BOOKED</option>
                                                        <option value="SOLD"
                                                            <?php if($veh['status'] == "SOLD"){echo 'selected';} ?>>SOLD
                                                        </option>
                                                    </select>
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                            ...
                                            <div class="control-group">
                                                <label for="is_special" class="col-md-4 control-label">Special Offer
                                                    Vehicle</label>
                                                <div class="radio inline">
                                                    <input class="checkbox" type="checkbox" id="is_special"
                                                        name="is_special"
                                                        <?php if($veh['is_special']==1){echo ' checked=checked ';} ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls  span6" style="margin:0 20px;">
                                                    <textarea id="EditorBox1"
                                                        name="description"><?=$veh['description']?></textarea>
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
                                                ...
                                                <div class="controls  span8" style="margin:0 20px;">
                                                    ...
                                                    <label class="span2">
                                                        <input type="checkbox" id="att_<?=$key?>"
                                                            name="attributes[<?=$key?>]" value="YES"
                                                            <?php if($val == "YES"){echo 'checked';} ?>>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <label class="radio inline">
                                                        <input type="radio" id="display_website1" name="display_website"
                                                            value="1"
                                                            <?php if($veh['display_website'] == "1"){echo 'checked';} ?>>
                                                        Yes
                                                    </label>
                                                    <label class="radio inline">
                                                        <input type="radio" id="display_website2" name="display_website"
                                                            value="0"
                                                            <?php if($veh['display_website'] == "0"){echo 'checked';} ?>>
                                                        No
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="model_grade">Youtube Video
                                                    Link</label>
                                                <div class="controls">
                                                    <input type="text" class="span6" id="youtube_video_link"
                                                        name="youtube_video_link"
                                                        value="<?=$veh['youtube_video_link']?>">
                                                </div> <!-- /controls -->
                                            </div> <!-- /control-group -->
